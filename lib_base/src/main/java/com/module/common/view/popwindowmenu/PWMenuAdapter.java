 ...
 * 菜单适配器
 */
public class PWMenuAdapter extends RecyclerView.Adapter<PWMenuAdapter.TRMViewHolder> {
    private Context mContext;
    private List<MenuItem> menuItemList;
    private boolean showIcon;
    private PopWindowMenu mTopRightMenu;
    private PopWindowMenu.OnMenuItemClickListener onMenuItemClickListener;

    public PWMenuAdapter(Context context, PopWindowMenu topRightMenu, List<MenuItem> menuItemList, boolean show) {
    ...
    public void setOnMenuItemClickListener(PopWindowMenu.OnMenuItemClickListener listener){
